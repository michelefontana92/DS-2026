...
class BaseDataset(Dataset):
    ...
    def setup(self):
        print('Setting up dataset from', self.data_path)
        self.id_to_combination_dict = {}
        x, y, groups,group_ids,local_weights ,self.feature_names= self._load_dataset()
    ...
    def _fit_scaler(self):
        ...
        self.scaler = fit_scalers(data_orig, self.cat_cols, self.num_cols, [],self.target)
    ...
    def _load_dataset(self,load_data=True):
        ...
        try:
            ...
            print('Scaler not found at', self.scaler_path, ', fitting scaler') 
        ...
        feature_names = [f for f  in data1.columns.tolist() if f!= self.target] 
        X = data1.values
        ...
        return X, y, s,group_ids,weights,feature_names
